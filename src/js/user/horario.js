...
function loadMockScheduleData() {
  ...
  scheduleState.events = [
    ...
    },
    {
      ...
      type: "work",
      title: "turno regular",
      startTime: new Date(startOfWeek.getTime() + 24 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000), // 9:00 AM Tuesday
      endTime: new Date(startOfWeek.getTime() + 24 * 60 * 60 * 1000 + 17 * 60 * 60 * 1000), // 5:00 PM Tuesday
      description: "turno regular",
    },
    {
      id: 3,
      ...
      startTime: new Date(startOfWeek.getTime() + 24 * 60 * 60 * 1000 + 11 * 60 * 60 * 1000), // 11:00 AM Tuesday
      endTime: new Date(startOfWeek.getTime() + 24 * 60 * 60 * 1000 + 12 * 60 * 60 * 1000), // 12:00 PM Tuesday
    ...
    },
    {
      ...
      type: "work",
      title: "turno regular",
      startTime: new Date(startOfWeek.getTime() + 2 * 24 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000), // 9:00 AM Wednesday
      endTime: new Date(startOfWeek.getTime() + 2 * 24 * 60 * 60 * 1000 + 17 * 60 * 60 * 1000), // 5:00 PM Wednesday
      description: "turno regular",
    },
    {
      id: 5,
      type: "work",
      title: "turno regular",
      startTime: new Date(startOfWeek.getTime() + 3 * 24 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000), // 9:00 AM Thursday
      endTime: new Date(startOfWeek.getTime() + 3 * 24 * 60 * 60 * 1000 + 17 * 60 * 60 * 1000), // 5:00 PM Thursday
    ...
    },
    {
      ...
      startTime: new Date(startOfWeek.getTime() + 3 * 24 * 60 * 60 * 1000 + 14 * 60 * 60 * 1000), // 2:00 PM Thursday
      endTime: new Date(startOfWeek.getTime() + 3 * 24 * 60 * 60 * 1000 + 15 * 60 * 60 * 1000), // 3:00 PM Thursday
    ...
    },
    {
      ...
      type: "work",
      title: "turno regular",
      startTime: new Date(startOfWeek.getTime() + 4 * 24 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000), // 9:00 AM Friday
      endTime: new Date(startOfWeek.getTime() + 4 * 24 * 60 * 60 * 1000 + 17 * 60 * 60 * 1000), // 5:00 PM Friday
      description: "turno regular",
    },
    {
      id: 8,
      ...
      startTime: new Date(startOfWeek.getTime() + 4 * 24 * 60 * 60 * 1000 + 15 * 60 * 60 * 1000), // 3:00 PM Friday
      endTime: new Date(startOfWeek.getTime() + 4 * 24 * 60 * 60 * 1000 + 17 * 60 * 60 * 1000), // 5:00 PM Friday
...
function generateSchedule() {
  ...
  timeSlots.forEach((hour) => {
    ...
    for (let day = 0; day < 5; day++) {
      ...
      // Agregar el evento de clic para seleccionar este día
      cell.addEventListener("click", () => selectDay(date, date.toLocaleDateString([], { weekday: "long" })))
...
function selectDay(date, dayName) {
  ...
  const formattedDate = date.toLocaleDateString([], { weekday: "long", year: "numeric", month: "long", day: "numeric" })
  ...
  showNotification(`Has seleccionado ${dayName}, ${formattedDate} para intercambio de horario`, "info")
...
function showEventDetails(event) {
  ...
  const date = event.startTime.toLocaleDateString([], { weekday: "long", month: "long", day: "numeric" })
  ...
  eventDetailsContent.innerHTML = `
       <div class="event-details">
           ...
           <div class="mb-3">
               <strong>Type:</strong> 
               <span class="badge ${event.type === "work" ? "bg-success" : event.type === "meeting" ? "bg-primary" : "bg-warning"}">
